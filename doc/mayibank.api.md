...
[[]{#OLE_LINK16 .anchor}]{#OLE_LINK15 .anchor}
discount\_pay\_method String(1000) 可空 折扣支付方式，无折扣则该栏位无需填写。 格式为JsonList，具体说明见下方接口参数补充说明。 {discount\_type: "allowancePay",instCode: "DISCOUNTPAY",amountInfo: "25.00"}\]
...
[]{#_Hlk439080084 .anchor}

trade\_status 交易状态 String(20) 见附录 不可空 TRADE\_FINISHED
